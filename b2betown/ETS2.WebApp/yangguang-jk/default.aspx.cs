...
namespace ETS2.WebApp.yangguang_jk
{
    public partial class _default : System.Web.UI.Page
    {
        ...
        {
            string xml = Request["xml"].ConvertTo<string>("");
            if (xml == "")
            {
                Response.Write("fail 接收参数为空");//参数为空
                return;
            }
