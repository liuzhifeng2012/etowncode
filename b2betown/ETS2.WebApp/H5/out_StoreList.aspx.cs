...
namespace ETS2.WebApp.H5
{
    public partial class out_StoreList : System.Web.UI.Page
    {
        ...
        public string channelcompanytype = "0,3,4";//渠道公司类型:0内部；1外部；3网站；4微信
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (weixincode != "")
            {
                ...
                if (Domain_def.Domain_yanzheng(RequestUrl))//如果符合shop101.etown.cn的格式，则从多微信商户基本信息表中获取comid
                {
                    ...
                    string openid_temp = GetOpenId_2(weixincode, comid);
                    GetMenshiDetail(openid_temp, comid);
                }
                else
                {
                    errlog = "公司id获取有误";
