<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ETS2.WebApp.H5.Default" %>
                    ...
                    if (data.type == 100) {
                        if (data.totalCount == 0) {
                            ...
                            for (i = 0; i < data.totalCount; i++) {
                                bannerlist = bannerlist + " <li style=\"width: 640px; display: table-cell; vertical-align: top;\"><a href=\"#\"><img src=\"" + data.msg[i].Imgurl_address + "\" alt=\"" + data.msg[i].Title + "\"  style=\"width:100%;\"  /></a></li>"
                            }
                        ...
                        if (data.totalCount == 0) {
                            ...
                            if (data.totalCount > left_daohang) {
                                for (i = 0; i < left_daohang; i++) {
                                    daohanglist = daohanglist + "<a href=\"" + data.msg[i].Linkurl + "\"><img alt=\"" + data.msg[i].Name + "\" src=\"" + data.msg[i].Imgurl_address + "\" /></a>"
                                }
                            }
