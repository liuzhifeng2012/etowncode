<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PeopleList.aspx.cs" Inherits="ETS2.WebApp.H5.PeopleList" %>
                ...
                if ($(document).height() <= totalheight) {
                    if (stop == true) {
                        ...
                        $.ajax({
                            ...
                            data: { comid: comid, pageindex: pageindex, pagesize: pageSize, channelcompanyid: 0, key: "", openid: $("#hid_openid").val(), usern: $("#usern").val(), usere: $("#usere").val() },
                            async: false,
