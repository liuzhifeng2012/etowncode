<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default5.aspx.cs" Inherits="ETS2.WebApp.H5.manage.Default5" %>
                    ...
                    if (data.type == 100) {
                        if (data.totalCount == 0) {
                            ...
                            for (i = 0; i < data.totalCount; i++) {
                                daohanglist = daohanglist + "<li><a href=\"/ui/shangjiaui/H5SetMenu_manage.aspx?id=" + data.msg[i].Id + "\"  title=\"编辑此栏目\"  target=\"_parent\" class=\"cate-item\"  id=\"menu" + data.msg[i].Id + "\" onmouseover=\"addmengban('menu" + data.msg[i].Id + "')\" onmouseout=\"remengban('menu" + data.msg[i].Id + "')\"><div><span class=\"" + data.msg[i].Fonticon + "\"></span></div><div>                                <p>" + data.msg[i].Name + "</p>                            </div></a> </li>";
                            }
...
<div class="body" style="padding-bottom:52px;">
    ...
    <div style="visibility: visible;" id="banner_box" class="box_swipe"  title="编辑此栏目" onmouseover="addmengban('banner_box')" onmouseout="remengban('banner_box')" onclick="parent.location.href='/ui/shangjiaui/H5Setlist.aspx'">
		<%=bannerstr %>
	</div>
    </div>
	<!-- 首页焦点图结束 -->
