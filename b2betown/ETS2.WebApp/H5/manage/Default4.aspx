<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default4.aspx.cs" Inherits="ETS2.WebApp.H5.manage.Default4" %>
                    ...
                    if (data.type == 100) {
                        if (data.totalCount == 0) {
                            ...
                            for (i = 0; i < data.totalCount; i++) {
                                ...
                                daohanglist += "<li><a href=\"/ui/shangjiaui/H5SetMenu_manage.aspx?id=" + data.msg[i].Id + "\"  title=\"编辑此栏目\"  target=\"_parent\" class=\"cate-item\"  id=\"menu" + data.msg[i].Id + "\" onmouseover=\"addmengban('menu" + data.msg[i].Id + "')\" onmouseout=\"remengban('menu" + data.msg[i].Id + "')\"><div><p>" + data.msg[i].Name + "</p></div></a></li>"
                            }
...
<div id="skin_index_control">
	<div class="bg"></div>
	<div style="padding-top:15px; text-align:center; color:#FFFFFF;">
