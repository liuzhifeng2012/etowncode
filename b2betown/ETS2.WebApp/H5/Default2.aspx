<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default2.aspx.cs" Inherits="ETS2.WebApp.H5.Default2" %>
                    ...
                    if (data.type == 100) {
                        if (data.totalCount == 0) {
                            ...
                            for (i = 0; i < data.totalCount; i++) {
                                    ...
                                    daohanglist = daohanglist + "<dl><a href=\"" + data.msg[i].Linkurl + "\">  <dt>"+ data.msg[i].Name + "</dt></a></dl>"
                            }
