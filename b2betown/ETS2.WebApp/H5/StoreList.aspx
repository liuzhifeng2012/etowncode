<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StoreList.aspx.cs" Inherits="ETS2.WebApp.H5.StoreList"  %>
...
//            });
            ...
            function SearchList(pageindex, pagesize, key) {
                ...
                $.ajax({
                    ...
                    data: { channelcompanyid: $("#hid_channelcompanyid").val(), comid: $("#hid_comid").val(), pageindex: pageindex, pagesize: pagesize, key: key, channelcompanytype: $("#hid_channelcompanytype").val() },
                    async: false,
