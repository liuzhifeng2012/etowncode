<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yuyuewaitpay.aspx.cs" Inherits="ETS2.WebApp.H5.order.yuyuewaitpay" %>
...
<div style=" padding-top:50px;">
    ...
    <!-- 展现类型判断 -->
            <ul id="list" class="sc-goods-list clearfix list size-3" style=" padding-bottom:50px;">
                    <li style="text-align: center; font-size:14px;">等</li>   
