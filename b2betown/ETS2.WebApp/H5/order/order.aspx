<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="ETS2.WebApp.H5.order.Order" %>
...
<div class="header">
 ...
 <hr class="margin-0 left-10">
    ...
    {{if Pay_state=="已支付"}}
        {{if pingjiastate ==0}}
        <div class="opt-btn">
         <a href="/h5/subevaluate.aspx?oid=${Id}" class="btn btn-in-order-list" >立即评价</a>
        </div>
        {{else}}
            <div class="opt-btn">
            <a href="/h5/subevaluate.aspx?oid=${Id}" class="btn btn-in-order-list" >我的评价</a>
            </div>
        {{/if}}
    {{/if}}
    <div class="opt-btn">
                        ...
                        {{if Order_state==2}}
                            ...
                            {{if Comid==112}}
                              <a href="quitorder.aspx?orderid=${Id}" class="btn btn-in-order-list" >我要退票</a>
                            {{/if}}
                        {{/if}}
                        {{if Order_state==4}}
                        {{if Server_type==1 || Server_type==3  }}
                               <a href="#" class="btn btn-in-order-list" >已发码 </a> 
                               {{if Comid==112}}
                                 <a href="quitorder.aspx?orderid=${Id}" class="btn btn-in-order-list" >我要退票</a>
                               {{/if}}
