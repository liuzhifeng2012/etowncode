...
{
    public partial class yuding_orderlist : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string Returnmd5 = EncryptionHelper.ToMD5(ntime + "lixh1210", "UTF-8");//订单加密验证

            if (Returnmd5 != md5ntime)
            {
                //验证错误
                state = 0;
                state_str = "MD5验证错误" ;
            ...
            try{
                //计算时间
                DateTime youxiaotime = Convert.ToDateTime(ntime);
                DateTime nowtime = DateTime.Now;
                TimeSpan ts = nowtime.Subtract(youxiaotime);//计算时间差 
            ...
            if (AccountId == 0)
            {
                ...
                Response.Redirect("/h5/order/login.aspx?come=/h5/order/yuding_orderlist.aspx");//非手机的跳转到V目录
            }
