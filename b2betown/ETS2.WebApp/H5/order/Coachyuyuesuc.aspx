<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Coachyuyuesuc.aspx.cs" Inherits="ETS2.WebApp.H5.order.Coachyuyuesuc" %>
...
<div style=" padding-top:50px;">
    ...
    <!-- 展现类型判断 -->
            <ul id="list" class="sc-goods-list clearfix list size-3" style=" padding-bottom:50px;">
                    <li style="text-align: center; font-size:14px;">预约教练详情</li>   
                     ...
                     <li style="text-align: center; padding:5px;font-size:14px;">请提前与教练联系。 </li>      
