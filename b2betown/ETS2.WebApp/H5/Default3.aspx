<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default3.aspx.cs" Inherits="ETS2.WebApp.H5.Default3" %>
                    ...
                    if (data.type == 100) {
                        if (data.totalCount == 0) {
                            ...
                            for (i = 0; i < data.totalCount; i++) {
                                ...
                                daohanglist += "<a href=\"" + data.msg[i].Linkurl + "\" class=\"cate-item\"><img src=\"" + imgurl + "\" class=\"cate-icon\" /><div class=\"cate-title\">" + data.msg[i].Name + "</div></a>"
                            }
