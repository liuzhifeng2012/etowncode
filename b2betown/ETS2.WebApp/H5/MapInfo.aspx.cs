        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (comid != 0)
            {
                ...
                if (comdata != null)
                {
                    ...
                    Com_name = comdata.Com_name;
                    Scenic_name = comdata.Scenic_name;
                    Com_add = comdata.B2bcompanyinfo.Scenic_address;
                    Coordinate=comdata.B2bcompanyinfo.Coordinate;
                    Tel=comdata.B2bcompanyinfo.Tel;
                    if (comdata.B2bcompanyinfo != null)
                    {
                    
                        weixinname = comdata.B2bcompanyinfo.Weixinname;
