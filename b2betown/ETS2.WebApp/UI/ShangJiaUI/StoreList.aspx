<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="/UI/Etown.Master"  CodeBehind="StoreList.aspx.cs" Inherits="ETS2.WebApp.UI.ShangJiaUI.StoreList" %>
        ...
        $(function () {
            ...
            function SearchList(pageindex) {
                ...
                $.ajax({
                    ...
                    data: { comid: comid, pageindex: pageindex, pagesize: pageSize, typeid: 1 },
                    async: false,
...
<asp:Content ID="content2" ContentPlaceHolderID="body" runat="server">
    <div id="settings" class="view main">
       <%-- <div id="secondary-tabs" class="navsetting ">
            <ul>
                ...
                <li class="on"><a href="/ui/shangjiaui/StoreList.aspx" onfocus="this.blur()" target="">门店模板设置</a></li>
                 <li><a href="/ui/shangjiaui/H5Default.aspx" onfocus="this.blur()" target="">微站形象首页管理</a></li>
        </div>--%>
        <div id="setting-home" class="vis-zone mail-list">
            <div class="inner">
                <h3>
                  门店背景图片管理  </h3> <a href="H5Setting.aspx?typeid=1"  class="a_anniu">添加背景图片</a>
    ...
    <script type="text/x-jquery-tmpl" id="ProductItemEdit">   
                    <tr>
                        ...
                        <td>
                            <p align="left">
                           <a href="H5Setting.aspx?id=${Id}&typeid=1"  class="a_anniu"> 管理 </a>  
                            </p>
