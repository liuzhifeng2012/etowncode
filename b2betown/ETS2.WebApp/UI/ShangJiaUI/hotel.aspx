        ...
        <div class="swiper-container" >
            <div class="swiper-wrapper">
               <div class="swiper-slide">
                   ...
                   云顶班车<i class="icon_arrow"></i></a></h4></div>
               </div>
            </div>
        </div>
    </div>
    <!-- 商品区域 -->
    <ul id="list1922" class="sc-goods-list pic clearfix size-1 ">
    <script>
        $(function () {

            SearchPorList(1, 20, 1922, 0, "list1922");
        ...
        <div class="swiper-container" >
            <div class="swiper-wrapper">
               <div class="swiper-slide">
                    <!-- 标题    --> 
                   <div class="shop_module_hd"><h4>
                   <a href="PJList.aspx?projectid=2284"> 
                   万龙班车<i class="icon_arrow"></i></a></h4></div>
               </div>
            </div>
        </div>
    </div>
    <!-- 商品区域 -->
    <ul id="list1952" class="sc-goods-list pic clearfix size-1 ">
    <script>
        $(function () {

            SearchPorList(1, 20, 1952, 2284, "list1952");
        ...
        <div class="swiper-container" >
            <div class="swiper-wrapper">
               <div class="swiper-slide">
                   ...
                   <div class="shop_module_hd"><h4>
                   <a href="PJList.aspx?projectid=2284"> 
                   多乐班车<i class="icon_arrow"></i></a></h4></div>
               </div>
            </div>
        </div>
    </div>
    <!-- 商品区域 -->
    <ul id="list1953" class="sc-goods-list pic clearfix size-1 ">
    <script>
        $(function () {

            SearchPorList(1, 20, 1953, 2284, "list1953");
