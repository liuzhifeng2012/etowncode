<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TravelbusOrderDetail.aspx.cs"
    MasterPageFile="/UI/Etown.Master" Inherits="ETS2.WebApp.UI.MemberUI.TravelbusOrderlist" %>
        ...
        $(function () {
                    ...
                    var d = '<ul id="ul_0">' +
                        '<li id="li_0">' +
                            '<div class="content-list-app">' +
                                '<b class="content-list-add"><input type="button" id="btnedit_0" value="编辑" style="display:none;width: 56px;height: 26px;font-size:12px; font-weight:normal;" disabled="disabled" onclick="editbus(0)"/></b>' +
                                '<div class="popover_content">' +
                                    '<div class="rich_buddy_hd">车辆情况</div>' +
                                    '<div class="rich_buddy_bd buddyRichContent" style="display: block;">' +
                                        ...
                                        '</div>' +
                                        '<div class="frm_control_group nickName">' +
                                            '<input type="button" id="btnsave_0" onclick="savebus(0)" value="保存" class="nicbutton"/>' +
                                            '<input type="button" id="btndel_0" onclick="delbus(0)" value="删除" class="nicbutton"/>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                    ...
                    if (data.totle > 0) {
                        ...
                        for (var jj = 0; jj < data.totle; jj++) {
                            ...
                            d += '<ul id="ul_' + jj + '">' +
                                            '<li id="li_' + jj + '">' +
                                                '<div class="content-list-app">' +
                                                    '<b class="content-list-add"><input type="button" id="btnedit_' + jj + '" value="编辑" style="width: 56px;height: 26px;font-size:12px; font-weight:normal;" onclick="editbus(' + jj + ')"/></b>' +
                                                    '<div class="popover_content">' +
                                                        '<div class="rich_buddy_hd">车辆情况</div>' +
                                                        '<div class="rich_buddy_bd buddyRichContent" style="display: block;">' +
                                                            '<div class="frm_control_group nickName">' +
                                                            ...
                                                            '</div>' +
                                                            '<div class="frm_control_group nickName">' +
                                                                '<input type="button" id="btnsave_' + jj + '" onclick="savebus(' + jj + ')" value="保存" class="nicbutton" style="display:none;" disabled="disabled" />' +
                                                                '<input type="button" id="btndel_' + jj + '" onclick="delbus(' + jj + ')" value="删除" class="nicbutton"  style="display:none;" disabled="disabled"/>' +
                                                            '</div>' +
                                                        '</div>' +
                                                    '</div>' +
                                                    '<div class="content-list-des text-overflow">' +
            ...
            $("#Button5").click(function () {
                ...
                var d = '<ul id="ul_' + busindex + '">' +
                        '<li id="li_' + busindex + '">' +
                            '<div class="content-list-app">' +
                                '<b class="content-list-add"><input type="button" id="btnedit_' + busindex + '" value="编辑" style="display:none;width: 56px;height: 26px;font-size:12px; font-weight:normal;" disabled="disabled" onclick="editbus(' + busindex + ')"/></b>' +
                                '<div class="popover_content">' +
                                    '<div class="rich_buddy_hd">车辆情况</div>' +
                                    '<div class="rich_buddy_bd buddyRichContent" style="display: block;">' +
                                        '<div class="frm_control_group nickName">' +
                                        ...
                                        '</div>' +
                                        '<div class="frm_control_group nickName">' +
                                            '<input type="button" id="btnsave_' + busindex + '" onclick="savebus(' + busindex + ')" value="保存" class="nicbutton"/>' +
                                            '<input type="button" id="btndel_' + busindex + '"  onclick="delbus(' + busindex + ')"  value="删除" class="nicbutton"/>' +
                                        '</div>' +
                                    '</div>' +
                                '</div>' +
                                '<div class="content-list-des text-overflow">' +
            ...
            $("#Button2").click(function () {
                ...
                //判断以前的派车是否都已经保存了
                var arr_issavebus = $("#hid_issavebus").val().split(',');
                var iscanaddbus = 1; //<!---操作类型:0编辑车辆操作；1保存车辆操作；2删除车辆操作-!-->
                for (var ii = 0; ii < arr_issavebus.length; ii++) {
                    if (arr_issavebus[ii] != "") {
                        if (arr_issavebus[ii] != 2) {
                            if (arr_issavebus[ii] == 0) {//如果有没有保存的车量信息，则不可以在派车
                                iscanaddbus = 0;
                            }
                        }
            ...
            <div class="inner">
                ...
                <table border="0">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="button" id="Button1" value="查看客户名单" style="width: 120px; height: 26px;" />
                ...
                <h3>
                    派车情况
                    <input type="button" id="Button5" value="加车" style="width: 80px; height: 26px;" />
                </h3>
                ...
                <table style=" margin-left:10px;">
                    ...
                    <tr>
                        <td colspan="5">
                            <input type="button" id="Button2" value="提 交" style="width: 120px; height: 26px;" />
                        </td>
                    </tr>
                </table>
            </div>
