<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="/UI/Etown.Master"  CodeBehind="IntegralList.aspx.cs" Inherits="ETS2.WebApp.UI.CrmUI.IntegralList" %>
    ...
    <div id="settings" class="view main">
       <%-- <div id="secondary-tabs" class="navsetting ">
            <ul>
                ...
                <li  class="on"><a href="IntegralList.aspx" target="" title="">积分详情</a></li>
                <li ><a href="ImprestList.aspx" target="" title="">会员预付款详情</a></li>
            </ul>
        </div>--%>
