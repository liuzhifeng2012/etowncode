<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="/UI/Etown.Master" CodeBehind="Imglibrary.aspx.cs" Inherits="ETS2.WebApp.UI.PermissionUI.Img_library" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="body" runat="server">
    <div id="settings" class="view main">
        <div id="secondary-tabs" class="navsetting ">
            <ul>
                ...
                <li class="on"><a href="Imglibrary.aspx" onfocus="this.blur()" target=""><span>标签图片库管理</span></a></li>
        ...
        <div id="setting-home" class="vis-zone mail-list">
            <div class="inner">
                <h3>
                  图片库管理  </h3> <a href="ImglibraryManage.aspx?usetype=0">添加新图片</a>
    ...
    <script type="text/x-jquery-tmpl" id="ProductItemEdit">   
                    <tr>
                        ...
                        <td>
                            <p align="left">
                           <a href=ImglibraryManage.aspx?id=${Id}&usetype=0> 管理 </a>  
                            </p>
