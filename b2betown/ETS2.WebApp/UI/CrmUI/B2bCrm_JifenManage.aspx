<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2bCrm_JifenManage.aspx.cs"       MasterPageFile="/UI/Etown.Master" Inherits="ETS2.WebApp.UI.CrmUI.B2bCrm_JifenManage" %>
        ...
        <div id="secondary-tabs" class="navsetting">
            <ul>
                   <li><a href="/ui/crmui/BusinessCustomersList.aspx" onfocus="this.blur()">
                    ...
                    会员级别设置</a></li>
                       <li  class="on"><a href="/ui/crmui/B2bCrm_jifenManage.aspx" onfocus="this.blur()">
                    会员积分设置</a></li>
            </ul>
        </div>
