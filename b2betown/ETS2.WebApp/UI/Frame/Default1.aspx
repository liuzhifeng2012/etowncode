<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default1.aspx.cs" Inherits="ETS2.WebApp.UI.Frame.Default1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Operatingstar() {
            ...
            $("#Operating").show();
            $("#OperatingTitle").html("订单提交成功，优惠券将发送到您提交的手机上");
        }
