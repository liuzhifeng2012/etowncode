<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="/UI/Etown.Master"  CodeBehind="CoopCount.aspx.cs" Inherits="ETS2.WebApp.UI.PMUI.CoopCount" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            function SearchList(pageindex) {
                ...
                $.ajax({
                    type: "post",
                    url: "/JsonFactory/OrderHandler.ashx?oper=coopcountlist",
        ...
        <div id="setting-home" class="vis-zone  mail-list">
            <div class="inner">
             <h3>
                ...
                <h3>
                   <a href="CoopCount.aspx" class="on">订单列表</a>  <a href="CoopCount_Verification.aspx">验证列表</a></h3>
