    ...
    var step = {
        ...
        Creat_Table: function () {
            ...
            if (bCheck == true) {
                ...
                var itemColumHead = $("<th  style=\"width:360px;\">门市价--直销价--1级分销价--2级分销价--3级分销价--结算价</th><th style=\"width:30px;\">重量</th><th style=\"width:30px;\">库存</th> ");
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        var td1 = $("<td ><input name=\"Txt_facePriceSon\" class=\"l-text\" type=\"text\" value=\"\" size='5' placeholder='门市价'>-" +
                        "<input name=\"Txt_advicePriceSon\" class=\"l-text\" type=\"text\" value=\"\" size='5' placeholder='直销价'>-" +
                        "<input name=\"Txt_agent1PriceSon\" class=\"l-text\" type=\"text\" value=\"\" size='8' placeholder='1级分销价'>-" +
                        "<input name=\"Txt_agent2PriceSon\" class=\"l-text\" type=\"text\" value=\"\" size='8' placeholder='2级分销价'>-" +
                        "<input name=\"Txt_agent3PriceSon\" class=\"l-text\" type=\"text\" value=\"\" size='8' placeholder='3级分销价'>-" +
                        "<input name=\"Txt_settlePriceSon\" class=\"l-text\" type=\"text\" value=\"\" size='5' placeholder='结算价'></td>");
                        td1.appendTo(tr);
                        var td2 = $("<td ><input name=\"Txt_WeightSon\" class=\"l-text\" type=\"text\" value=\"\"  size='5'></td>");
                        td2.appendTo(tr);
                        var td3 = $("<td ><input name=\"Txt_CountSon\" class=\"l-text\" type=\"text\" value=\"\"  size='5'></td>");
                        td3.appendTo(tr);
