...
(function ($) {
    $.prompt = function (message, options) {
        ...
        msgbox += '<div class="' + $.prompt.options.prefix + '" id="' + $.prompt.options.prefix + '">';

        /*Libing 修改样式,添加标题*/


        msgbox += '<div class="' + $.prompt.options.prefix + 'title"><h1>: : ' + $.prompt.options.title + ' : :</h1>';
        msgbox += '<span></span>';
        msgbox += '</div><div class="' + $.prompt.options.prefix + 'container">';
        msgbox += '<div id="' + $.prompt.options.prefix + 'states"></div>';
        msgbox += '</div></div></div>';
        ...
        $.each(message, function (statename, stateobj) {
            ...
            $state.children('.' + $.prompt.options.prefix + 'buttons').children('button').click(function () {
                ...
                $state.trigger(promptsubmite, [clicked, msg, forminputs,title]);

                if (!promptsubmite.isDefaultPrevented()) {
                    $.prompt.close(true, clicked, msg, forminputs,title);
                }
            });
        ...
        $.prompt.jqi.find('.' + $.prompt.options.prefix + 'title span').click($.prompt.close);
    ...
    $.prompt.close = function (callCallback, clicked, msg, formvals,title) {
