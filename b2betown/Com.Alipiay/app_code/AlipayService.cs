...
namespace Com.Alipay
{
    ...
    public class Service
    {
        ...
        public Service()
        {
            Config configset = new Config();
            _partner = configset.Partner.Trim();
            _input_charset = configset.Input_charset.Trim().ToLower();
            _seller_email = configset.Seller_email.Trim();
            _return_url = configset.Return_url.Trim();
            _notify_url = configset.Notify_url.Trim();
        }
        ...
        {
            Config configset = new Config();
            string url = GATEWAY_NEW + "service=query_timestamp&partner=" + configset.Partner;
            string encrypt_key = "";
