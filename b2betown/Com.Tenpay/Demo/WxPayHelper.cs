...
namespace Com.Tenpay
{
    public class WxPayHelper
    {
        ...
        public string GetCftPackage()
        {
            ...
            string unSignParaString = Com.Tenpay.CommonUtil.FormatBizQueryParaMap(parameters,
                    false);
            string paraString = Com.Tenpay.CommonUtil.FormatBizQueryParaMap(parameters, true);
            return paraString + "&sign="
                    + Com.Tenpay.MD5SignUtil.Sign(unSignParaString, PartnerKey);
        ...
        public string GetBizSign(Dictionary<string, string> bizObj)
        {
            ...
            string bizString = Com.Tenpay.CommonUtil.FormatBizQueryParaMap(bizParameters, false);

            return Com.Tenpay.SHA1Util.Sha1(bizString);
        ...
        public string CreateAppPackage(string traceid)
        {
            ...
            nativeObj.Add("noncestr", Com.Tenpay.CommonUtil.CreateNoncestr());
        ...
        public string CreateNativeUrl(string productid)
        {
            ...
            try
            {
                ...
                bizString = Com.Tenpay.CommonUtil.FormatBizQueryParaMap(nativeObj, false);
        ...
        public string CreateNativePackage(string retcode, string reterrmsg)
        {
            ...
            return Com.Tenpay.CommonUtil.ArrayToXml(nativeObj);
