...
namespace WxPayAPI
{
    public class WxPayApi
    {
        ...
        public static WxPayData OrderQuery(WxPayData inputObj, WxPayConfig config, int timeOut = 6)
        {
            ...
            string xml = inputObj.ToXml(config);

            var start = DateTime.Now;

            Log.Debug("WxPayApi", "OrderQuery request : " + xml,config);
            string response = HttpService.Post(xml, url, false, timeOut,config);//调用HTTP通信接口提交数据
            Log.Debug("WxPayApi", "OrderQuery response : " + response,config);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj, WxPayConfig config, int timeOut = 60)
        {
            ...
            Log.Debug("WxPayApi", "Refund request : " + xml,config);
            string response = HttpService.Post(xml, url, true, timeOut,config);//调用HTTP通信接口提交数据到API
            Log.Debug("WxPayApi", "Refund response : " + response,config);
        ...
        */
        public static WxPayData ShortUrl(WxPayData inputObj, WxPayConfig config, int timeOut = 6)
        {
            ...
            Log.Debug("WxPayApi", "ShortUrl request : " + xml,config);
            string response = HttpService.Post(xml, url, false, timeOut,config);
            Log.Debug("WxPayApi", "ShortUrl response : " + response,config);
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, WxPayConfig config, int timeOut = 6)
        {
            ...
            Log.Debug("WxPayApi", "UnfiedOrder request : " + xml,config);
            string response = HttpService.Post(xml, url, false, timeOut,config);
            Log.Debug("WxPayApi", "UnfiedOrder response : " + response,config);
        ...
        */
        private static void ReportCostTime(string interface_url, int timeCost, WxPayData inputObj,WxPayConfig config)
        {
            //如果不需要进行上报
        ...
        */
        public static WxPayData Report(WxPayData inputObj,WxPayConfig config, int timeOut = 1)
        {
            ...
            Log.Info("WxPayApi", "Report request : " + xml,config);

            string response = HttpService.Post(xml, url, false, timeOut,config);

            Log.Info("WxPayApi", "Report response : " + response,config);
